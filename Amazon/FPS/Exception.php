...

{
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if(array_key_exists('StatusCode', $errorInfo)) {
            ...
            if(array_key_exists('ErrorType', $errorInfo)) {
                $this->_errorType = $errorInfo["ErrorType"];
            } else {
                $this->_errorType = "";
            }
            if(array_key_exists('RequestId', $errorInfo)) {
                $this->_requestId = $errorInfo["RequestId"];
            } else {
                $this->_requestId = "";
            }
            if(array_key_exists('XML', $errorInfo)) {
