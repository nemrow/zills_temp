...
class digitalMusic extends DataClassBase {
    ...
    public function __construct($db) {
        $this->tableName = 'digitalmusic';
        $this->tableType = 'Digital Music';
        ...
        $this->colNames[$this->colCount] = 'attachmentId';
        $this->colTypes[$this->colCount++] = 'int';
